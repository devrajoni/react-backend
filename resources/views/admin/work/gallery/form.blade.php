    ...
    <div class="row my-6 py-6">
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-body">
                    <form action="{{ isset($workGallery) ? route('work-gallery.update', $workGallery->id) : route('work-gallery.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @isset($workGallery) @method('PUT') @endisset
                        ...
                        <div class="row pt-6">
                            <x-ui.input
                                ...
                                multiple
                            />
                            <p>Width:360 Height:200</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 d-flex">
                                @foreach ($workGalleries as $data)
                                    <div class="image">
                                        <meta name="csrf-token" content="{{ csrf_token() }}">

                                        <img src="{{ asset($data->image) }}" alt="" id="gallery" class="p-2">
                                        <button type="button" data-id="{{ $data->id }}" data-url="{{ route('work-gallery.destroy', $data->id)}}" class="deleteRecord btn text-danger">
