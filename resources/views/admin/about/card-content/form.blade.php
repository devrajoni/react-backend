    ...
    <div class="row my-6 py-6">
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-body">
                    <form action="{{ isset($aboutCard) ? route('about-card.update', $aboutCard->id) : route('about-card.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @isset($aboutCard) @method('PUT') @endisset
                        <div class="row pt-6">
                            <x-ui.input
                                group="col-md-12"
                                :label="__('Title')"
                        ...
                        <div class="row">
                            <x-ui.input
                                ...
                                id="description"
                                class="summernote"
                                :value="$aboutCard->description ?? null"
                            />
                        </div>
                        <div class="row pb-6">
                            <div class="col-md-12">
